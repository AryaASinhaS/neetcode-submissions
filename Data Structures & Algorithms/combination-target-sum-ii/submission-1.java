class Solution {
    public List<List<Integer>> combinationSum2(int[] nums, int target) {
        ...
        return distinctLists(combinationList);
    }
    ...
    public List<List<Integer>> distinctLists(List<List<Integer>> combinationList)
    {
        HashSet<List<Integer>> hs = new HashSet<>(combinationList);
