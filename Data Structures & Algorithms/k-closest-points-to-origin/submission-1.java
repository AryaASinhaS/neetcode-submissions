class Point implements Comparable<Point>
{
    ...
    public int compareTo(Point point)
    {
        ...
        */
        ...
        if(currentPointDistanceFrmCntr == otherPointDistanceFrmCntr)
            result = 0;
        else if(currentPointDistanceFrmCntr > otherPointDistanceFrmCntr)
            result = 1;
        else
            result = -1;
...
class Solution {
    public int[][] kClosest(int[][] points, int k) {
        ...
        PriorityQueue<Point> minPQ = new PriorityQueue<>(Collections.reverseOrder());
