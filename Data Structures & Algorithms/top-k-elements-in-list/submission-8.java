class Solution {
    public int[] topKFrequent(int[] nums, int k) {
        ...
        1. Insert all elements to hadshmap and log in itrs frequency
        2. create an array of size n+1 called freq[] where freq[i] will be the list of elements that have occured i times in nums, 
           the array can max consist of all same elements, hence m ax length of the array can be n, n+1 as nums[i] >= 1
        3. traverse through the hashmap to fill freq[] array
        4. start from the end of freq array and maintain a counter for k, print all elements till counter = k
